    ...
    let(:env_config) do
      {
        ...
        :enable_job_enqueue_instrumentation => false,
        :enable_minutely_probes => false,
        ...
        :instrument_active_job => false,
        :instrument_code_ownership => false,
        :instrument_delayed_job => false,
        :instrument_excon => false,
        :instrument_faraday => false,
        :instrument_http_rb => false,
        :instrument_mongo => false,
        :instrument_net_http => false,
        :instrument_ownership => false,
        :instrument_que => false,
        :instrument_redis => false,
        :instrument_resque => false,
    ...
    let(:env_vars) do
      {
        ...
        "APPSIGNAL_INSTRUMENT_ACTIVE_JOB" => "false",
        "APPSIGNAL_INSTRUMENT_CODE_OWNERSHIP" => "false",
        "APPSIGNAL_INSTRUMENT_DELAYED_JOB" => "false",
        "APPSIGNAL_INSTRUMENT_EXCON" => "false",
        "APPSIGNAL_INSTRUMENT_FARADAY" => "false",
        "APPSIGNAL_INSTRUMENT_HTTP_RB" => "false",
        "APPSIGNAL_INSTRUMENT_MONGO" => "false",
        "APPSIGNAL_INSTRUMENT_NET_HTTP" => "false",
        "APPSIGNAL_INSTRUMENT_OWNERSHIP" => "false",
        "APPSIGNAL_INSTRUMENT_QUE" => "false",
        "APPSIGNAL_INSTRUMENT_REDIS" => "false",
        "APPSIGNAL_INSTRUMENT_RESQUE" => "false",
        "APPSIGNAL_INSTRUMENT_SEQUEL" => "false",
        "APPSIGNAL_INSTRUMENT_SHORYUKEN" => "false",
        "APPSIGNAL_INSTRUMENT_SIDEKIQ" => "false",
  ...
  describe Appsignal::Config::ConfigDSL do
    ...
    describe "#dsl_options" do
      it "keeps an empty array the block assigned" do
        # `response_headers` names no headers by default, and reading an
        # option gives back the value the config already holds, so assigning
        # an empty array looks like a read unless the assignment itself is
        # recorded.
