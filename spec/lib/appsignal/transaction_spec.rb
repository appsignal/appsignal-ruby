describe Appsignal::Transaction do
  ...
  describe "#suppress_http_client_events" do
    let(:transaction) { new_transaction }

    it "suppresses HTTP client events for the duration of the block" do
    ...
    it "resets the suppression when the block raises" do
      expect do
        transaction.suppress_http_client_events { raise "error" }
  ...
  describe "#add_query_parameters" do
    ...
    describe "setting the query parameters on the transaction" do
      def perform
        transaction.add_query_parameters("key" => "value")
      end
      ...
      it "in collector mode", :collector_mode do
        ...
        expect(JSON.parse(root_span.attributes["appsignal.request.query_parameters"]))
          .to eq("key" => "value")
        expect(root_span.attributes).to_not have_key("appsignal.request.payload")
        expect(root_span.attributes).to_not have_key("appsignal.function.parameters")
      end
    ...
    describe "merging and giving the block precedence" do
      def perform
        transaction.add_query_parameters("abc" => "value")
        transaction.add_query_parameters("def" => "value")
        transaction.add_query_parameters { { "xyz" => "value" } }
      end
      ...
      it "in collector mode", :collector_mode do
        ...
        expect(JSON.parse(root_span.attributes["appsignal.request.query_parameters"])).to eq(
          "abc" => "value", "def" => "value", "xyz" => "value"
        )
      end
    end

    describe "#add_query_parameters_if_nil does not override existing params" do
      def perform
        transaction.add_query_parameters("original" => "value")
        transaction.add_query_parameters_if_nil("other" => "value")
      end
  ...
  describe "#add_request_headers" do
    ...
    describe "adding a header named in another spelling" do
      ...
      it "in collector mode", :collector_mode do
        ...
        # The caller and the option each named the header their own way, and
        # the allowlist still keeps it, under the one name the collector
        # compares against.
